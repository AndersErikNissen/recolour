...
<template>
  <div>
    <div class="mb-6">
      <h1 class="text-2xl font-bold">Out partners</h1>
      <p class="text-brand-800 mt-1 max-w-md">
        Below you will find a simple overview over all our partners.
      </p>
    </div>

    <ul class="rounded-xl grid lg:grid-cols-5 gap-3 relative">
      ...
      <li v-if="partners.length === 0" class="col-span-full">
        <p class="py-10 px-5 text-xs text-center">There are currently no partners, try again later!</p>
      </li>
    </ul>
  </div>
</template>
